...
drug_classes <- list(
  ...
  SedativeHypnotics = c("lemborexant"),
  ...
  Heart_AngiotenssinReceptorBlocker = c("atacand"),
  ...
  Pain_AntiInflammatory = c("meloxicam", "naproxen", "sumatriptan", "naratriptan", "asa","ecasa"),
  ...
  CholinergicAgonist = c("pilocarpine"),
  CholesterolAbsorbtionInhibitor = c('ezetimibe')
)
